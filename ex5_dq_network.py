...
import cv2,sys               # http://blog.topspeedsnail.com/archives/4755
...
def train_neural_network(input_image):
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            reward, image = game.step(list(argmax_t)) #计算前期随机移动获得的reward
            ...
            if n % 10000 == 0:
                saver.save(sess, model_path, global_step = n)  # 保存模型
